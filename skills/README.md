...
| 技能 | 定位 | 核心职责与场景 |
| :--- | :--- | :--- |
| **nuwa** | 思维框架蒸馏 | 花叔开源的女娲 skill。输入人名/需求，自动深度调研→思维框架提炼→生成可运行的人物 Skill。支持两种入口：(1)明确人名直接蒸馏；(2)模糊需求诊断推荐。6 Agent 并行调研 + 3 验证 Agent + 双 Agent 精炼，产出结构化思维模型。 |
| **khazix-writer** | 公众号长文写作 | 以卡兹克文风撰写公众号深度长文。 |
| **wechat-post-html** | 公众号 HTML 排版 | 将 Markdown 文章转为公众号兼容 HTML，方案C极简大留白风格，复制粘贴到公众号后台即可发布。 |
| **hv-analysis** | 横纵分析法深度研究 | 系统性研究产品/公司/概念/人物的通用框架，纵轴追历史深度，横轴做竞品广度。 |
| **寓言写作** | 概念学习工具 | 基于Anthropic Amanda Askell寓言教学法，通过AI生成寓言故事来解释任何抽象概念，5分钟完成概念理解。配合横纵分析法可先做初步感知。 |
