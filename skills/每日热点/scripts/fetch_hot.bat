...
REM 运行时间：每日 9:00
REM
REM 环境要求：设置 DAILY_HOT_DIR 环境变量指向输出目录
REM   示例: set DAILY_HOT_DIR=D:\github\zmyAI\每日热点

if "%DAILY_HOT_DIR%"=="" (
    echo [错误] 请先设置 DAILY_HOT_DIR 环境变量
    echo 示例: set DAILY_HOT_DIR=D:\github\zmyAI\每日热点
    exit /b 1
)

set OUTDIR=%DAILY_HOT_DIR%
set TODAY=%DATE:~0,10%
